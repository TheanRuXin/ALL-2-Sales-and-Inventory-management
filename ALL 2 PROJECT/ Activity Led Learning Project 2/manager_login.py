...
class ManagerLoginPage(ctk.CTkFrame):
    ...
    def login(self):
        ...
        if user:
            ...
            if bcrypt.checkpw(password.encode(), stored_hashed_password.encode()):
                if role == "Admin":
                    messagebox.showerror("Access Denied", "You cannot login here as Admin!")
                    ...
                    UserProfileApp(profile_window, user_id)
    ...
    def new_account(self):
        self.controller.show_frame("Manager_Register")
    ...
    def setup_ui(self):
        ...
        back_button = ctk.CTkButton(self, text="Back", bg_color="#D9D9D9", fg_color="Blue",
                                       ...
                                       font=("Iter", 14),command=self.back)
