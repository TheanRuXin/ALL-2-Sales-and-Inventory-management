...
class CategoriesPage(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.search_entry.bind("<Return>", lambda event: self.search_button())
        # Reset Button
        ...
        self.tree.column("quantity", width=80, anchor="w")
        self.tree.column("price", width=100, anchor="w")
        self.tree.column("status", width=100, anchor="w")
        self.tree.column("register_date", width=120, anchor="w")

        self.scrollbar = ttk.Scrollbar(self, orient="vertical", command=self.tree.yview)
        self.tree.configure(yscrollcommand=self.scrollbar.set)

        self.tree.place(x=50, y=70, width=1220, height=450)
        self.scrollbar.place(x=1270, y=70, height=450)
