...
class RegisterProductPage(ctk.CTkFrame):
    def __init__(self,parent,controller):
        ...
        self.width, self.height = 1484, 800
    ...
    def create_widgets(self):
        ...
        self.category_combobox = ctk.CTkComboBox(self, values=self.categories, variable=self.category,fg_color="#ebf9ff", border_color="#0C5481",
                                                 button_color="#0C5481", button_hover_color="#52a0bf", font=("Arial", 18), width=395, height=45)
        self.category_combobox.place(x=(205 / 1920 * self.width)-50, y=400 / 974 * self.height)

        self.add_category_link = ctk.CTkLabel(self, bg_color="#FFFFFF",fg_color="#FFFFFF", text="Add a new category", font=("Arial", 16, "underline"),
        ...
        #OR CODES
        self.qr_label = ctk.CTkLabel(self, text="QR Code will appear here", bg_color="#FFFFFF", fg_color = "#ebf9ff",width = 197, height = 197)
