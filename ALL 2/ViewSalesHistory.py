...
class SalesHistoryPage(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        ctk.CTkButton(self.left_frame, text="Sales Analysis", command=self.sales_analysis, width=238,height=35, fg_color="#2155CD", font=("Arial", 20)).place(x=10, y=480)
    ...
    def fetch_sales_data(self):
        ...
        # ✅ GROUP BY added to combine by date + item + category
        query += " GROUP BY strftime('%Y-%m-%d', sale_date), item_name, category"
        ...
        for row in rows:
            ...
            formatted_row[4] = f"{formatted_row[4]:.2f}"  # Format total price
